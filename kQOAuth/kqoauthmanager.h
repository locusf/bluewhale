...
public:
     ...
     *       ther user's permission to access protected resources. Opening URL: " << userAuthURL;
        mOauthManager->getUse acess token. Hence, this returns true if setHandleUserAuthorization() is set to true
     ...
     */
    void getUserAuthorization(QUrl authorizationEndpoint, QWebView* browser);
    /**
